...
<div class="form-group" >
            ...
            <input type="string" class="form-control" id="ItemID" name="ItemID" placeholder="Item ID">

        </div>
<div class="form-group">
            <label for="exampleInputName">Item Name </label>
            <input type="string" class="form-control" id="ItemName" name="ItemName" placeholder="Item Name">
...
<div class="form-group">
            ...
            <input type="submit" class="form-control" id="submit" name="submit" onclick="return validate();" value="Update Item">
